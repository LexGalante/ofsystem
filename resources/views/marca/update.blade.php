...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><i class="fa fa-plus"></i> Alterar</li>
</ol>
<div class="card mb-3">
	<!-- FORM -->
			...
			<div class="row">
				<div class="col-md-8">
    				<div class="form-group">
                        <input type="text" class="form-control" id="marca" name="marca" placeholder="Informe o nome da marca" value="{{ $marca->marca }}">
                        @if ($errors->has('marca'))
				...
				<div class="col-md-4">
    				<div class="form-group">
                    	<select class="form-control" id="origem" name="origem">
                    		<option {{ ($marca->origem == 'N')? 'selected' : '' }} value="N">NACIONAL</option>
                          	<option {{ ($marca->origem == 'I')? 'selected' : '' }} value="I">IMPORTADO</option>
                        	<option {{ ($marca->origem == 'A')? 'selected' : '' }} value="A">NACIONAL/IMPORTADO</option>
                    	</select>
                	</div>	
    			</div>
			</div>
