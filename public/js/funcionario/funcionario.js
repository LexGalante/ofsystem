...
{
	var tabela_contatos = $('#tabela-contatos').find('tbody');
	...
	linha += '				<option value="C">CELULAR</option>';
	linha += '				<option value="T">TELEFONE FIXO</option>';
	linha += '				<option value="E">E-MAIL</option>';
	linha += '				<option value="S">WEB SITE</option>';
	linha += '			</select>';
	linha += '		</div>';
	linha += '	</td>';
	linha += '	<td>';
